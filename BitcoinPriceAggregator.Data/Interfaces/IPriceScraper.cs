namespace BitcoinPriceAggregator.Data.Interfaces
{
    public interface IPriceScraper
    {
        ...
        /// <exception cref="BitcoinPriceAggregator.Data.Exceptions.ScrapingFailedException">Thrown when retrieval of data point failed</exception>
